...
# System config
use constant ADMIN_PASS => 'secretPASSWORDSRULE';			# Admin password. For fucks's sake, change this.
use constant SECRET => '304112875';				# Cryptographic secret. CHANGE THIS to something totally random, and long.
...
# Page look
use constant TITLE => 'local noagenda board';	# Name of this image board
